...
export default function Nav() {
  return (
    <Disclosure
      as="nav"
      className="fixed top-0 left-0 right-0 z-50 bg-gray-800 dark:bg-gray-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10 text-gray-400"
    >
                  ...
                  <a
                    ...
                    className={classNames(
                      item.current
                        ...
                        : 'text-gray-300 dark:text-gray-300 hover:bg-white/5 hover:text-white',
